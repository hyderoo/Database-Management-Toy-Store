...
<div class="card">
    <div class="card-header">
        <h4 class="mt-5 text-center h1 fw-bolder">Data Customer Terhapus</h4>

        <div class="container d-flex mb-3">
            <form class="d-flex" role="search" method="GET" action="{{ route('customer.search_trash') }}">
        ...
        <table class="table table-hover mt-2 table-bordered boder-primary rounded text-center shadow p-3 mb-5 rounded">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $data->phone }}</td>
                    <td>
                        <a href="{{ route('customer.restore', $data->customer_id) }}" type="button" class="btn btn-outline-warning rounded-3">Restore</a>
                        ...
                        <div class="modal fade" id="hapusModal{{ $data->customer_id }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('customer.delete', $data->customer_id) }}">
                                        @csrf
