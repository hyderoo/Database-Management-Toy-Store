...
<div class="card mt-4 bg-light text-black shadow p-3 mb-5 rounded">
    <div class="card-body">
        ...
        <h5 class="card-title fw-bolder mb-3 h2 text-center">Edit Data Toy</h5>

        <form method="post" action="{{ route('toy.update', $data->toy_id) }}">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="toy_name" name="toy_name" value="{{ $data->toy_name }}">
            </div>
            <div class="mb-3">
