...
<div class="card">
    <div class="card-header">
        <h4 class="mt-5 text-center h1 fw-bolder">Data Transaksi Terhapus</h4>

        <div class="container d-flex mb-3">
            <form class="d-flex" role="search" method="GET" action="{{ route('transaksi.search_trash') }}">
        ...
        <table class="table table-hover mt-2 table-bordered boder-primary rounded text-center shadow p-3 mb-5 rounded">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('transaksi.restore', $data->transaksi_id) }}" type="button" class="btn btn-outline-warning rounded-3">Restore</a>
                        ...
                        <div class="modal fade" id="hapusModal{{ $data->transaksi_id }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('transaksi.delete', $data->transaksi_id) }}">
                                        @csrf
